  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 text-gray-900">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
        <h2 className="mb-6 text-center text-2xl font-bold text-gray-800">{t('auth.register_title')}</h2>
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          {t('auth.has_account')} <Link to="/login" className="text-blue-600 hover:underline">{t('auth.login_title')}</Link>
        </p>
      </div>
    </div>
  );
