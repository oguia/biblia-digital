...
foreach ($urls_encartes_encontrados as $encarte) {
    ...
    // Chamada cURL para o Gemini (Visão) usando a versão mais estável: gemini-1.5-pro
    $url_gemini = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent?key=" . $GEMINI_API_KEY;
