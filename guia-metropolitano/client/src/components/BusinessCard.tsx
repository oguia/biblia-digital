    ...
    >
      ...
      <div className="p-6 flex-grow flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-start">
            <div>
               ...
               <Link to={`/negocio/${business.slug}`} className="hover:text-green-600 transition-colors">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link to={`/negocio/${business.slug}`} className="px-4 py-3 border border-slate-200 rounded-xl hover:bg-slate-50 text-slate-600 transition-colors">
