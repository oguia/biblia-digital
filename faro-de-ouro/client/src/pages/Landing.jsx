...
const Landing = () => {
  return (
    <div className="min-h-screen bg-brand-gray-light font-sans selection:bg-brand-orange selection:text-white">
      {/* Header */}
      <header className="bg-brand-black text-white p-4 sticky top-0 z-50 shadow-md">
        <div className="container mx-auto flex justify-between items-center max-w-6xl">
          <div className="flex items-center gap-3">
            <Package className="text-brand-orange w-8 h-8" />
            <span className="font-bold text-xl tracking-wider">FARO DE OURO</span>
          </div>
          <div className="flex items-center gap-4">
            <Link to="/login" className="text-gray-300 hover:text-white transition">Entrar</Link>
            <Link to="/register" className="bg-brand-orange text-white px-5 py-2 rounded-lg font-semibold hover:bg-orange-600 transition shadow-lg shadow-orange-500/30">
              Teste Grátis
            </Link>
          </div>
        </div>
      ...
      <section className="bg-brand-black text-white py-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-brand-orange via-brand-black to-brand-black pointer-events-none"></div>
        <div className="container mx-auto px-4 max-w-6xl text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/register" className="bg-brand-orange text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-orange-600 transition transform hover:-translate-y-1 shadow-xl shadow-orange-500/20">
              Começar Teste de 7 Dias
            </Link>
            <Link to="/login" className="bg-white/10 text-white border border-white/20 px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/20 transition">
              Já tenho uma conta
            </Link>
          </div>
        </div>
      ...
      <section className="bg-brand-orange py-16">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <Link to="/register" className="bg-brand-black text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-900 transition shadow-xl inline-block">
      ...
      <footer className="bg-brand-black text-gray-400 py-12 border-t border-white/10">
        <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            ...
            <span className="font-bold text-white tracking-wider">FARO DE OURO</span>
          </div>
