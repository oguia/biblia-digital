        ...
        <aside class="lg:w-1/3 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    ...
                    <span class="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full font-bold"><?= count($contextoGeo) ?> Locais</span>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 relative">
                    ...
                    <div class="relative pl-10 mb-6">
                        ...
                        <h4 class="text-lg font-bold text-gray-800"><?= htmlspecialchars($cronologia['periodo']) ?></h4>
                        <p class="text-sm text-gray-500">Aprox. <?= htmlspecialchars($cronologia['ano_estimado']) ?></p>
                    </div>
                    ...
                    <div class="relative pl-10 mb-6">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed"><?= htmlspecialchars($cronologia['personagens']) ?></p>
                    </div>
                    ...
                    <div class="relative pl-10">
                        ...
                        <p class="text-sm text-gray-600 italic leading-relaxed">"<?= htmlspecialchars($cronologia['eventos_mundiais']) ?>"</p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
